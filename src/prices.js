...
export const Prices = [
    ...
    {id: "platinum",price_id: 'price_1JfHjQGEnOOm6AiQSwDAI7u1', name: 'KaiserBody Bundle Ultimate Pack + 6 Bottles Queen Formula', price: '294.00', code: '21142', alias:'ultimate', bottles:'6 Bottles Queen Formula', product:'qf'},
    {id: "gold",price_id: 'price_1Jx0nWGEnOOm6AiQ4OyoGTI5',name: 'KaiserBody Bundle Premium Pack + 3 Bottles Queen Formula', price: '177.00', code: '21141',alias:'premium', bottles:'3 Bottles Queen Formula', product:'qf'},
    {id: "bronze",price_id: 'price_1Jx0nrGEnOOm6AiQO0f7ue5g',name: 'KaiserBody Bundle Basic Pack + 1 Bottle Queen Formula', price: '69.00', code: '21140',alias:'basic', bottles:'1 Bottle Queen Formula', product:'qf'},
    {id: "platinum-saver",price_id: '25361', name: 'KaiserBody Bundle Ultimate Savers-Pack + 6 Bottles Queen Formula (Delivery Every 180 Days)', price: '234.00', code: '25361', alias:'ultimate-saver', bottles:'6 Bottles Queen Formula', product:'qf'},
    {id: "gold-saver",price_id: '25360',name: 'KaiserBody Bundle Premium Savers-Pack + 3 Bottles Queen Formula (Delivery Every 90 Days)', price: '147.00', code: '25360',alias:'premium-saver', bottles:'3 Bottles Queen Formula', product:'qf'},
