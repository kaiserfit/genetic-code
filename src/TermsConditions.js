...
export default function TermsConditions(){
    ...
    return (
        <>
         ...
         <h1 className="text-center mt-3">KaizerFit</h1>

    <div className="container c2">
      <h1 className="text-center">Terms of Use</h1>
      <p>
        This website is operated by KaizerFit (“Company,” “we,” “us,” or “our”), through our website, www.kaizerfit.com (“Website”), offers weight management programs (“Programs” or “products and services”) for sale. Company offers Programs for sale subject to these Terms of Use (the “Terms”), which may be updated by us from time to time.
      </p>
      <p>
...
NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM THE COMPANY OR THROUGH THE WEBSITE SHALL CREATE ANY WARRANTY NOT EXPRESSLY MADE HEREIN.
          ...
          <h3>Limitations of Liability and Damages</h3>
          <p>
          ...
          <p>All Website design, text, graphics, and the selection and arrangement thereof, are owned by Company. ALL RIGHTS RESERVED.</p>
          <h3>Enforcement of Rules and Policies</h3>
          <p>
          ...
          <h3>Enforcement of Rules and Policies</h3>
          <p>
            We may allow you and users of our websites to communicate, submit, upload or otherwise make available text, reviews, stories, images, photos, audio, video, media, chats, testimonials, personally identifiable information (including health, wellness and nutritional data), feedback about our products and services, or any other content (“User Content”). User Content that you submit through your KaizerFit  User Gallery or any other KaizerFit  service will be stored, maintained and used by KaizerFit  in accordance with our Privacy Policy. You acknowledge certain types of User Content that you submit, such as chats, photos, reviews, and message board entries, may be accessed and viewed by the public.
            <br /><br />
You may not submit or upload User Content that KaizerFit determines in its sole and absolute discretion is illegal, infringing, false, defamatory, harassing, threatening, bigoted, hateful, violent, vulgar, obscene, pornographic, or otherwise offensive or that harms or can reasonably be expected to harm any person or entity, whether or not such material is protected by law. We have the right, but not the obligation, to monitor, screen, post, remove, modify, store and review User Content or communications you submit, at any time and for any or no reason, including to ensure that the User Content or communication conforms to these Terms, without prior notice to you.
<br /><br />
You hereby grant KaizerFit  an exclusive and unlimited license to use such materials to promote their business and to create new and additional products for their users. Notwithstanding any photographs or personally identifiable information will be removed upon request from websites that are owned by KaizerFit.
<br /><br />
In the event that a personal identifiable photograph or other User Content is posted on a site outside of KaizerFit’s control you reserve the right to enforce your property rights against that third party offender. You however agree to indemnify KaizerFit from the leak or reposting and may not pursue damages against KaizerFit for the dissemination of this User Content as long as it was used along with the terms of this agreement. If a leak happens in which an employee or contractor of KaizerFit releases said images or other User Generated Content you understand and assume the risk of this dissemination. You may pursue that individual personally either civilly or criminally but you understand that in order for KaizerFit to provide complete protection the cost to do so would be prohibitive to the business and as such they specifically designate that you assume that risk in working on this site.
          </p>
          <h3>Governing Law</h3>
          <p>
         ...
         <br /><br />
          <p>This arbitration agreement does not preclude your bringing issues to the attention of federal, state, or local agencies. Such agencies can, if the law allows, seek relief against us on your behalf. You agree that, by entering into these Terms, you and Company are each <strong>WAIVING THE RIGHT TO A TRIAL BY JURY OR TO PARTICIPATE IN A REPRESENTATIVE, GROUP, COLLECTIVE OR CLASS ACTION OR ARBITRATION.
          </strong></p>
          <p>
...
You may download or copy a form to initiate arbitration from the American Arbitration Association (“AAA”) website at:<br />
<a href="https://www.adr.org/sites/default/files/Business%20and%20Consumer%20Submission%20to%20Non-Binding%20Arbitration_2.pdf"><span className="emphasis">https://www.adr.org/sites/default/files/Business%20and%20Consumer%20Submission%20to%20Non-Binding%20Arbitration_2.pdf</span></a>
          </li>
          <li>
        ...
        <p>
          We offer a 90 day money back guarantee on all purchases made on the Website, All refunds will be calculated according to the actual purchase price paid at the time of purchase. Please note that returns for credit and debit card transactions are issued within two (2) business days, however it may take up to five (5) for the credit to post to your credit card or bank account. If you are mistakenly sent a different product than what you ordered, or if the product is defective upon receipt, we will replace the product at no additional cost to you. Please note that Digital Products, Coaching Products and Physical Products have difrent conditions to be eligable for a refund. Please email us for all cancellation and refund enquiries at <a href="mailto:service@kaiserfit.net" style={{color: "#9c2c66"}}>service@kaiserfit.net</a>.
          <br /> <br />
...
To request a refund or exchange, contact Customer Service at <a href="mailto:service@kaiserfit.net" style={{color: "#9c2c66"}}>service@kaiserfit.net</a> during regular business hours, Customers ineligible for a refund may be granted a partial refund in our sole and absolute discretion.
We are not liable for any refund amount due to technical problems on your computer, including but not limited to: printer malfunction, inability to install Adobe Acrobat Reader, and/or problems due to Internet connectivity.
        ...
        <h3>
          Physical Products - Supplements/Scales/Clothing/ & Any Other Physical Products
        </h3>
        <p>All physical products come with a 90 day money back guarantee (from the date of delivery). If you are not satisfied with your product at any point, remember you are protected by the highest standard 100% money-back guarantee. Just send back the product and we’ll refund you. To do this simply email us at: <a href="mailto:service@kaiserfit.net" style={{color: "#9c2c66"}}>service@kaiserfit.net</a></p>
        <h3>
          Coaching Products
        </h3>
        <p>
          Our Coaching products require a VERY HEAVY investment of time and resources from our coaches. This is why coaching products are excluded from our 30 day money back guarantee.
        </p>
        <h3>
          Digital Products
        </h3>
        <p>
          Our 30 day money back guarantee is conditional upon you going through the material and completing it before you are eligible for a refund. This is to ensure you have committed to the Program fully.
          <br /> <br />
Proof of completion may include completing all the lessons in the program and filling out the Dream Body Planner spreadsheet as evidence.
        </p>
        <h3>
        ...
        <br />
        <p>
          Our designated agent to receive notifications of claimed infringement is: KaizerFit, ,LLC, Attn: DMCA Notice. Only DMCA notices should go to the agent; any other communications should be directed to our customer service department via <a href="mailto:service@kaiserfit.net" style={{color: "#9c2c66"}}>service@kaiserfit.net</a>.
          <br />   <br />
In order to contact Company regarding a complaint about the Website or Materials, please contact us at <a href="mailto:service@kaiserfit.net" style={{color: "#9c2c66"}}>service@kaiserfit.net</a>.
        </p>
        <h3>
